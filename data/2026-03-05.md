...
### [34] [Cross-Modal Mapping and Dual-Branch Reconstruction for 2D-3D Multimodal Industrial Anomaly Detection](https://arxiv.org/abs/2603.03939)
...
### [35] [Glass Segmentation with Fusion of Learned and General Visual Features](https://arxiv.org/abs/2603.03718)
...
### [36] [Towards Generalized Multimodal Homography Estimation](https://arxiv.org/abs/2603.03956)
...
### [37] [QD-PCQA: Quality-Aware Domain Adaptation for Point Cloud Quality Assessment](https://arxiv.org/abs/2603.03726)
...
### [38] [BLOCK: An Open-Source Bi-Stage MLLM Character-to-Skin Pipeline for Minecraft](https://arxiv.org/abs/2603.03964)
*Hengquan Guo*
...
### [39] [GeoSeg: Training-Free Reasoning-Driven Segmentation in Remote Sensing Imagery](https://arxiv.org/abs/2603.03983)
...
### [40] [DAGE: Dual-Stream Architecture for Efficient and Fine-Grained Geometry Estimation](https://arxiv.org/abs/2603.03744)
...
### [41] [When Visual Evidence is Ambiguous: Pareidolia as a Diagnostic Probe for Vision Models](https://arxiv.org/abs/2603.03989)
...
### [42] [WSI-INR: Implicit Neural Representations for Lesion Segmentation in Whole-Slide Images](https://arxiv.org/abs/2603.03749)
...
### [43] [Discriminative Perception via Anchored Description for Reasoning Segmentation](https://arxiv.org/abs/2603.04002)
...
### [44] [Seeing as Experts Do: A Knowledge-Augmented Agent for Open-Set Fine-Grained Visual Understanding](https://arxiv.org/abs/2603.03762)
...
### [45] [Volumetric Directional Diffusion: Anchoring Uncertainty Quantification in Anatomical Consensus for Ambiguous Medical Image Segmentation](https://arxiv.org/abs/2603.04024)
...
### [46] [LiDAR Prompted Spatio-Temporal Multi-View Stereo for Autonomous Driving](https://arxiv.org/abs/2603.03765)
...
### [47] [DQE-CIR: Distinctive Query Embeddings through Learnable Attribute Weights and Target Relative Negative Sampling in Composed Image Retrieval](https://arxiv.org/abs/2603.04037)
...
### [48] [Efficient Point Cloud Processing with High-Dimensional Positional Encoding and Non-Local MLPs](https://arxiv.org/abs/2603.04099)
...
### [50] [TAP: A Token-Adaptive Predictor Framework for Training-Free Diffusion Acceleration](https://arxiv.org/abs/2603.03792)
...
### [51] [Crab$^{+}$: A Scalable and Unified Audio-Visual Scene Understanding Model with Explicit Cooperation](https://arxiv.org/abs/2603.04128)
...
### [52] [PlaneCycle: Training-Free 2D-to-3D Lifting of Foundation Models Without Adapters](https://arxiv.org/abs/2603.04165)
...
### [53] [Adaptive Enhancement and Dual-Pooling Sequential Attention for Lightweight Underwater Object Detection with YOLOv10](https://arxiv.org/abs/2603.03807)
...
### [54] [CubeComposer: Spatio-Temporal Autoregressive 4K 360° Video Generation from Perspective Video](https://arxiv.org/abs/2603.04291)
...
### [55] [Vector-Quantized Soft Label Compression for Dataset Distillation](https://arxiv.org/abs/2603.03808)
...
### [56] [MOO: A Multi-view Oriented Observations Dataset for Viewpoint Analysis in Cattle Re-Identification](https://arxiv.org/abs/2603.04314)
...
### [57] [Structure-aware Prompt Adaptation from Seen to Unseen for Open-Vocabulary Compositional Zero-Shot Learning](https://arxiv.org/abs/2603.03815)
...
### [58] [SPRINT: Semi-supervised Prototypical Representation for Few-Shot Class-Incremental Tabular Learning](https://arxiv.org/abs/2603.04321)
...
### [59] [RANGER: Sparsely-Gated Mixture-of-Experts with Adaptive Retrieval Re-ranking for Pathology Report Generation](https://arxiv.org/abs/2603.04348)
...
### [60] [Universal Pansharpening Foundation Model](https://arxiv.org/abs/2603.03831)
...
### [61] [ZipMap: Linear-Time Stateful 3D Reconstruction with Test-Time Training](https://arxiv.org/abs/2603.04385)
...
### [62] [All-in-One Image Restoration via Causal-Deconfounding Wavelet-Disentangled Prompt Network](https://arxiv.org/abs/2603.03839)
...
### [63] [DeepScan: A Training-Free Framework for Visually Grounded Reasoning in Large Vision-Language Models](https://arxiv.org/abs/2603.03857)
...
### [64] [Bridging Human Evaluation to Infrared and Visible Image Fusion](https://arxiv.org/abs/2603.03871)
...
### [65] [Yolo-Key-6D: Single Stage Monocular 6D Pose Estimation with Keypoint Enhancements](https://arxiv.org/abs/2603.03879)
...
### [66] [UniSync: Towards Generalizable and High-Fidelity Lip Synchronization for Challenging Scenarios](https://arxiv.org/abs/2603.03882)
...
### [67] [From Misclassifications to Outliers: Joint Reliability Assessment in Classification](https://arxiv.org/abs/2603.03903)
...
### [68] [Architecture and evaluation protocol for transformer-based visual object tracking in UAV applications](https://arxiv.org/abs/2603.03904)
...
### [69] [Fine-grained Image Aesthetic Assessment: Learning Discriminative Scores from Relative Ranks](https://arxiv.org/abs/2603.03907)
...
### [70] [N-gram Injection into Transformers for Dynamic Language Model Adaptation in Handwritten Text Recognition](https://arxiv.org/abs/2603.03930)
...
### [71] [DISC: Dense Integrated Semantic Context for Large-Scale Open-Set Semantic Mapping](https://arxiv.org/abs/2603.03935)
